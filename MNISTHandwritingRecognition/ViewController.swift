...
//         create a classification request and tell it to call handleClassification once its done
        let classificationRequest =  VNRecognizeTextRequest(completionHandler: self.handleClassification)
        
       
//        // non-realtime asynchronous but accurate text recognition
//       classificationRequest.recognitionLevel = VNRequestTextRecognitionLevel.accurate
        
        
        // nearly realtime but not-accurate text recognition
        classificationRequest.recognitionLevel = VNRequestTextRecognitionLevel.fast
    ...
    func handleClassification (request:VNRequest, error:Error?) {
        ...
        let classifications = observations.compactMap { observation in
